...
<strong class="red">TODO:</strong> Are UKIs auto-signed by 91-sbctl.install?
I should check with `sbctl verify`.

<strong class="red">TODO:</strong> Is uefi-mkconfig already handled
by 95-efistub-kernel-bootcfg.install?

<strong class="red">TODO:</strong> This is a manual compile.
Isn't just reemerging @module-rebuild after a from-source
kernel enough? See [make.conf ⟹](/conf/make.conf#secure-boot).

Then sign the [Nvidia drivers ⟹](/conf/graphics)
using the kernel's autogenerated key (you may
need to reinstall said drivers, e.g. @module-rebuild).
