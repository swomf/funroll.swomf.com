...
I also use wl-clipboard and gpu-screen-recorder around those three.
...
```diff path=/etc/portage/patches/gui-apps/swappy/02-pull-197-squash-1.5.1-e1eea64.patch
